    ...
    <div className="mx-auto flex min-h-screen max-w-[1400px] flex-col gap-4 p-4 lg:p-6">
      ...
      <footer className="flex flex-col items-center gap-2 pb-2 sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <a
            href="https://github.com/ruffdog272/mm0tob-air-scatt"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-md border border-border/60 bg-secondary/40 px-2.5 py-1 font-mono text-[10px] text-muted-foreground/70 transition-colors hover:border-foreground/40 hover:bg-secondary hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
          >
            <svg
              viewBox="0 0 16 16"
              width="12"
